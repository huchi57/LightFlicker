...
public class LightFlickerEditor : Editor
{
    ...
    private void DrawPreviewGraph()
    {
        ...
        using (var _ = new GUILayout.HorizontalScope(GUILayout.Height(_graphHeight)))
        {
            ...
            GUI.enabled = false;
            EditorGUILayout.CurveField("", IntensityCurve.animationCurveValue, Color.yellow, new Rect(0, 0, Pattern.arraySize - 1, 2), GUILayout.ExpandWidth(true), GUILayout.Height(_graphHeight));
